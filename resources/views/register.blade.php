    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <div class="nav-menu nav-menu-right">
                <a href="voting.html" class="nav-link">Səsvermə</a>
                <a href="sponsors.html" class="nav-link">Sponsorlar</a>
                <a href="register.html" class="nav-link cta-link active">Qoşul</a>
            </div>
            <div class="hamburger">
                <span></span>
                <span></span>
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-brand">
                    ...
                    <p>Gələcək burada. Avtomobilinlə tanışma vaxtı.</p>
                </div>
                <div class="footer-links">
                    <div class="link-group">
                        ...
                        <a href="voting.html">Səsvermə</a>
                        <a href="register.html">Üzv Ol</a>
                    </div>
                    <div class="link-group">
                        <h4>Əlaqə</h4>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 Hyper Drive. Bütün hüquqlar qorunur.</p>
            </div>
        </div>
    </footer>
